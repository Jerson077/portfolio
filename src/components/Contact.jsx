        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          <div className="lg:col-span-1 space-y-8">
            <div className="glass p-8 border-white/5 space-y-6">
              ...
              <div className="flex items-center space-x-6 group">
                ...
                <div>
                   ...
                   <p className="text-white font-medium">jersonjerson223@gmail.com</p>
                </div>
              </div>
            ...
            <div className="glass p-8 border-white/5 flex justify-between px-12">
              <motion.a whileHover={{ y: -5, color: '#6366f1' }} href="#" target="_blank" rel="noopener noreferrer" className="text-white/40"><FaGithub size={28} /></motion.a>
          ...
          <div className="lg:col-span-2">
            <form ref={formRef} onSubmit={handleSubmit} className="glass p-10 border-white/5 space-y-8">
              ...
              <motion.button 
                ...
                className={`w-full py-5 text-lg flex items-center justify-center space-x-3 transition-colors ${
                  success ? 'bg-green-500 hover:bg-green-600 text-white font-bold rounded-xl' : 'btn-primary'
