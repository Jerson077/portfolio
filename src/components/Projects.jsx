...
const Projects = () => {
  const projects = [
    {
      title: "CPI Inflation Prediction",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 text-center">
           <motion.button 
             ...
             className="px-10 py-4 glass border-white/10 rounded-full text-white/50 font-bold hover:text-white hover:border-white/20 transition-all"
           >
             View More on GitHub
           </motion.button>
        </div>
