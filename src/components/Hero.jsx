...
const Hero = () => {
  ...
  const skills = ["Python", "SQL", "Power BI", "Machine Learning", "Data Visualization"];
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black font-outfit mb-6 leading-[1.1]">
            Hi, I'm <span className="text-gradient whitespace-nowrap">Jerson D M</span>
          </h1>
          ...
          <div className="min-h-[120px] lg:min-h-[96px] mb-8 group">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold font-outfit text-white/80 leading-[1.3]">
              Aspiring <span className="text-white">Data Analyst</span> & Finance <br/>
              Passionate learner of <span className="text-primary tracking-wider">{skillText}</span>
          ...
          <p className="text-lg text-white/50 max-w-lg mb-10 leading-relaxed font-light">
            I craft data-driven solutions and predictive models that bridge the gap between financial insight and artificial intelligence. 
        ...
        >
          ...
          {/* Floating insights box removed per user request */}
        </motion.div>
      </div>
